...
class ObjectTypeModule:
    ...
    def __init__(self, module):
        ...
        # (dialog, mapTo3d, layer, type_index=0)
        self.setupWidgets = getattr(module, 'setupWidgets')
        self.layerProperties = getattr(
            module, 'layerProperties', self.a_dict)    # (writer, layer)
        # (writer, layer, feat)
        self.write = getattr(module, 'write')
...
class ObjectTypeManager:
    ...
    def __init__(self):
        # load object types
        self.modules = []
        # each list item is ObjectTypeItem object
        ...
        module_fullnames = map(
            lambda x: "Qgis2threejs.objects." + x,
            module_names)
    ...
    def setupWidgets(self, ppage, mapTo3d, layer, geom_type, item_index):
        ...
        return self.modules[typeitem.mod_index].setupWidgets(
            ppage, mapTo3d, layer, typeitem.type_index)
