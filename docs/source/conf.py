# -*- coding: utf-8 -*-
#
# Qgis2threejs plugin documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../'))  # plugin directory
...
if not on_rtd:  # only import and set the theme if we're building docs locally
    if os.environ.get('READTHEDOCS', None) == 'Local':
...
htmlhelp_basename = 'Qgis2threejsplugindoc'
