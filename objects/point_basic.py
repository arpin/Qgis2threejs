...
def setupWidgets(ppage, mapTo3d, layer, type_index=0):
    ...
    if type_index == 0:  # Sphere
        ...
        ppage.addStyleWidget(
            StyleWidget.FIELD_VALUE, {
                "name": "Height", "defaultValue": defaultValueZ, "layer": layer})
        ...
        ppage.addStyleWidget(
            StyleWidget.FIELD_VALUE, {
                "name": "Depth", "defaultValue": defaultValue, "layer": layer})
        ppage.addStyleWidget(
            StyleWidget.FIELD_VALUE, {
                "name": "Height", "defaultValue": defaultValueZ, "layer": layer})
        ...
        ppage.addStyleWidget(
            StyleWidget.FIELD_VALUE, {
                "name": "Radius", "defaultValue": defaultValue, "layer": layer})
        ppage.addStyleWidget(StyleWidget.FIELD_VALUE,
                             {"name": "Dip",
                              "label": "Degrees",
                              "defaultValue": 0,
                              "label_field": None,
...
def write(writer, layer, feat):
    ...
    if feat.prop.type_index == 0:  # Sphere
        ...
        writer.writeFeature({"m": mat, "pts": pts, "rt": rt,
                             "rb": rb, "h": h, "rotateX": 90})
        ...
        writer.writeFeature({"m": mat, "pts": pts, "w": w,
                             "d": d, "h": h, "rotateX": 90})
