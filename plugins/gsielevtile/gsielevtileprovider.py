...
class GSIElevTileProvider:
    ...
    def getDataset(self, xmin, ymin, xmax, ymax, mapUnitsPerPixel):
        ...
        if self.last_dataset and self.last_dataset[0] == [
                zoom, ulx, uly, lrx, lry]:    # if same as last tile set, return cached dataset
        ...
        res = size / TILE_SIZE
        geotransform = [ulx * size - TSIZE1,
                        res, 0, TSIZE1 - uly * size, 0, -res]
